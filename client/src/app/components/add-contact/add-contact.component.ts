...
export class AddContactComponent{
  formModel: FormGroup;
  constructor(private usersServ: UsersService, private validators: ValidatorsService, private fb: FormBuilder, private message: MessagesService) {
  ...
  sendFriendRequest(){
    ...
    if(input.email === user.email ){
      ...
      this.usersServ.friendshipRequest({userId: user._id, contact: input.email})
